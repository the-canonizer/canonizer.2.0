...
<div class="col-sm-5 margin-btm-2">
    <form id="login_form" action="{{ url('/login')}}" method="post">
        ...
        <div class="form-group">
        <button type="submit"  id="request_opt" class="form-control btn btn-login">Request One Time Password</button>
        
        <div id="requesting_otp" style="display:none;" class="form-control btn btn-login">Requesting One Time Password..</div>
    </div>
    </form>
 </div>
