    ...
    <div class="right-whitePnl">
        <div class="col-sm-5 margin-btm-2">
            ...
            <form id="login_form" action="{{ url('/login') }}" method="post">
                ...
                <div class="form-group">
                    <button type="submit" id="submit" onclick="submitLoginForm(this)"
                        class=" form-control btn btn-login responsive-width">Log in</button>
                    <div id="loggingin" style="display:none;" class=" form-control btn btn-login">Logging in..</div>
                </div>
                <div class="form-group">
                    <label class="text-center col-sm-12">OR <input style="display:none;" type="checkbox" name="request_opt"
                            id="request_opt_checkbox"></label>
                </div>
                <div class="form-group">
                    <button type="submit" id="request_opt" class="form-control btn btn-login responsive-width">Request One
                        Time Verification Code</button>

                    <div id="requesting_otp" style="display:none;" class="form-control btn btn-login responsive-width">
                        Requesting One Time Verification Code..</div>
                </div>
                ...
                <div class="col-sm-12 margin-btm-2 ">
                    ...
                    <div class="form-group row">
                        <div class="col-md-2 mt-1">
                            <a href="{{ url('/login/google') }}" class="btn google btn-google-plus"><i
                                    class="fa fa-google fa-fw">
                                </i> Google+</a>
                        </div>
                        <div class="col-md-2 mt-1">
                            <a href="{{ url('/login/facebook') }}" class="btn facebook btn-facebook"> <i
                                    class="fa fa-facebook fa-fw"></i> Facebook</a>
                        </div>
                        <div class="col-md-2 mt-1">
                            <a href="{{ url('/login/twitter') }}" class="btn twitter btn-twitter"><i
                                    class="fa fa-twitter fa-fw"></i> Twitter</a>
                        </div>
                        <div class="col-md-2 mt-1">
                            <a href="{{ url('/login/github') }}" class="btn github btn-github"><i
                                    class="fa fa-github fa-fw"></i> GitHub</a>
                        </div>
                        <div class="col-md-2 mt-1">
                            <a href="{{ url('/login/linkedin') }}" class="btn linkedin btn-linkedin"><i
