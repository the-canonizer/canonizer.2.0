				                ...
				                <select name="nick_name" id="nick_name" class="form-control">
				                 ...
				                 {{-- @if ($errors->has('nick_name')) <p class="help-block">{{ $errors->first('nick_name') }}</p> @endif --}}
								  <?php if(count($userNicknames) == 0) { ?>
                                     <p class="help-block" style="color:red">Note:You have not yet added a nick name. A public or private nick name must be added then selected here when contributing.</p>
