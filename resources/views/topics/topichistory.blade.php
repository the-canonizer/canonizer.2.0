...
<div class="right-whitePnl">
    ...
    <div>
        ...
        <?php if ($currentTime < $data->go_live_time && $currentTime >= $data->submit_time) { ?>
                            ...
                            <a id="version" class="btn btn-historysmt" href="<?php echo url('topic/' . $data->topic_num . '/' . ($data->camp_num) ? $data->camp_num : 1 . '?asof=bydate&asofdate=' . date('Y/m/d H:i:s', $data->submit_time)); ?>">View This Version</a>
