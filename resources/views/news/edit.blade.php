...
<div class="right-whitePnl">
    <div class="row col-sm-12 justify-content-between">
        <div class="col-sm-12 margin-btm-2">
            <form action="{{ url('/newsfeed/update')}}" method="post" id="topicForm">
                ...
                <div style="float:left;clear:both;width:100%" id="sortable" class="nubeT">
                    ...
                    <div style="position: relative;" class="sortable rowNews " title="drag & drop to change order">
                        ...
                        <div  class="form-group col-sm-6">
                            <label for="namespace">Link <span style="color:red">*</span></label>
                            <input type="text" name="link[]" class="form-control" id="link" value="{{old('link.'.$key,$feed->link)}}">
