@component('mail::message')
 ...
 @elseif(isset($data['support_deleted']) && $data['support_deleted'] == 1 && $data['delegate_support_deleted'] == 1)
 {{ $data['nick_name']}} has just removed their delegated support to {{(isset($data['delegated_user']))? $data['delegated_user'] :'you'}} in this camp: <a href="{{ $link }}"><b>{{ $data['object']}}</b></a>
 @else
