...
return [
    ...
    */
    ...
    //'mail_env' => '[canon]',
    'mail_env' => ( env('APP_ENV', 'development') == 'staging' ||
        ( env('APP_ENV', 'development') == 'local' ) ) ?
        ( env('APP_ENV', 'development') == 'local' ) ? '[local.canon]' : '[staging.canon]' : '[canon]',
    ...
    */
    ...
    'url' => env('APP_URL', 'http://localhost//canonizer/public'),
