...
class TestPages(unittest.TestCase):
    ...
    def test_canonizer_login_with_valid_user(self):
        ...
        self.assertTrue(loginPage.login_with_valid_user(DEFAULT_USER, DEFAULT_PASS))
    ...
    def test_verify_warning_directly_supporting_child_camp(self):
        ...
        self.assertIn('support/173-Software-Testing/3-Levels-Of-Testing', result)
    ...
    # TC_LOGIN_PAGE_SHOULD_HAVE_REGISTER_OPTION_FOR_NEW_USERS
    ...
    # TC_UPLOAD_FILE_WITH_BLANK_FIELD
    ...
    def test_verifying_nick_name_from_dropdown_while_creating_topic(self):
        #print("\n", str(test_cases('TC_VERIFYING_NICKNAME_FROM_DROPDOWN_WHILE_CREATING_TOPIC')))
        self.login_to_canonizer_app()
        result = CanonizerCreateNewTopicPage(self.driver).click_create_new_topic_page_button() \
    ...
    def test_upload_file_with_valid_format(self):
        ...
        result = CanonizerUploadFilePage(self.driver).click_upload_file_page_button().upload_file_with_valid_format(
            DEFAULT_ORIGINAL_FILE_NAME, 'testing19111')
    ...
    # TC_VERIFY_CHANGE_PASSWORD_SAVE_BUTTON
    ...
    # TC_VERIFY_CHANGE_PASSWORD_SAVE_BUTTON_ON_ENTER_KEY
    ...
    def test_load_add_camp_statement_page(self):
        ...
        result = AddCampStatementPage(self.driver).load_add_camp().create_camp("camp" + add_name).load_add_camp_statement_page()
    ...
    def test_add_camp_statement_page_without_mandatory_fields(self):
        ...
        add_name = ''.join(random.choices(string.ascii_uppercase +
                                          string.digits, k=7))
        result = AddCampStatementPage(self.driver).load_add_camp().create_camp("camp" + add_name) \
    ...
    def test_add_camp_statement_page_mandatory_fields_only(self):
        ...
        add_name = ''.join(random.choices(string.ascii_uppercase +
                                          string.digits, k=7))
        result = AddCampStatementPage(self.driver).load_add_camp().create_camp("camp" + add_name) \
        .load_add_camp_statement_page().add_camp_statement_page_mandatory_fields_only("Test statement").get_url()
        self.assertIn("statement/history", result)
    ...
    def test_add_camp_statement_page_valid_data(self):
        ...
        # Click on the Create New camp  link
        result = AddCampStatementPage(self.driver).load_add_camp().create_camp("camp" + add_name) \
        .load_add_camp_statement_page().add_camp_statement_page_valid_data("Test statement", "Testing for note").get_url()
        self.assertIn("statement/history", result)
    ...
    def test_add_camp_statement_page_invalid_data(self):
        ...
        # Click on the Create New camp  link
        result = AddCampStatementPage(self.driver).load_add_camp().create_camp("camp" + add_name)\
        .load_add_camp_statement_page().add_camp_statement_page_invalid_data("").get_url()
        self.assertIn("create/statement", result)
    ...
    def test_add_camp_statement_page_data_with_trailing_spaces(self):
        ...
        add_name = ''.join(random.choices(string.ascii_uppercase +
                                          string.digits, k=7))
        result = AddCampStatementPage(self.driver).load_add_camp().create_camp("camp" + add_name).load_add_camp_statement_page()\
            .add_camp_statement_page_valid_data(
    ...
    # TC_BLOG_PAGE_FOOTER_COPYRIGHT_YEAR_WITHOUT_LOGIN
    def test_check_blog_page_footer_should_have_copyright_year_without_login(self):
        print("\n" + str(test_cases('TC_BLOG_PAGE_FOOTER_COPYRIGHT_YEAR_WITHOUT_LOGIN')))
        # Click on the Blog link
        currentyear = datetime.now().year
        self.assertIn('(2006 -' + str(currentyear) + ')',
                      CanonizerBlog(self.driver).blog_footer_should_have_privacy_policy_and_terms_services())
    ...
    def test_check_login_page_open_click_login_here_link(self):
        ...
        registerpage = CanonizerRegisterPage(
            self.driver).click_register_button().check_login_page_open_click_login_here_link().get_url()
        self.assertIn("/login", registerpage)
    ...
    # 254 For now service link is removed from left panel
    ...
    def test_login_with_the_account_that_is_registered_but_not_verified(self):
        ...
        result = CanonizerLoginPage(self.driver).login_with_the_account_that_is_registered_but_not_verified(UNVERIFY_EMAIL, UNVERIFY_PASS)
    ...
    def test_load_thread_posts_page(self):
        ...
        self.assertIn("forum/173-Software-Testing/1-Agreement/threads/484", result)
    ...
    def test_verify_sorted_tree_name_with_live_name(self):
        ...
        self.assertIn("topic/173-Software-Testing/3-Levels-Of-Testing#statement", result)
