...
class NewsFeedController extends Controller
{
    ...
    public function store(Request $request){
       ...
       // echo "<pre>"; print_r($all); exit;
        ...
        $messages["link.regex"]='Link is invalid.';
