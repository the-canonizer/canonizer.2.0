...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'bug-blog' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'bug-blog' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'bug-blog' ),
			'200'       => esc_attr__( 'Light 200', 'bug-blog' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'bug-blog' ),
			'300'       => esc_attr__( 'Book 300', 'bug-blog' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'bug-blog' ),
			'400'       => esc_attr__( 'Normal 400', 'bug-blog' ),
			'regular'   => esc_attr__( 'Normal 400', 'bug-blog' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'bug-blog' ),
			'500'       => esc_attr__( 'Medium 500', 'bug-blog' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'bug-blog' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'bug-blog' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'bug-blog' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'bug-blog' ),
			'700'       => esc_attr__( 'Bold 700', 'bug-blog' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'bug-blog' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'bug-blog' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'bug-blog' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'bug-blog' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'bug-blog' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'bug-blog' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'bug-blog' ),
		);
	}
