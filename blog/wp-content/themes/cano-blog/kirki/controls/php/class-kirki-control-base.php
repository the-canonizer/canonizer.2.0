...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected' => esc_attr__( 'No File Selected', 'bug-blog' ),
				'remove'         => esc_attr__( 'Remove', 'bug-blog' ),
				'default'        => esc_attr__( 'Default', 'bug-blog' ),
				'selectFile'     => esc_attr__( 'Select File', 'bug-blog' ),
				'standardFonts'  => esc_attr__( 'Standard Fonts', 'bug-blog' ),
				'googleFonts'    => esc_attr__( 'Google Fonts', 'bug-blog' ),
			)
		);
